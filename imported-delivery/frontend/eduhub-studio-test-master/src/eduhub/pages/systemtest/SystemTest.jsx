...
function IntegrityScreen({ onAgree, onCancel, lang, setLang }) {
  ...
  return (
    <motion.section
      ...
      style={{
        background:
          "radial-gradient(ellipse at top, rgba(255,122,58,0.12), transparent 60%), rgba(5,0,16,0.7)",
  ...
  return (
    ...
    >
      <motion.div
        ...
        style={{
          background:
            "radial-gradient(ellipse at top, rgba(0,224,255,0.12), transparent 60%), rgba(5,0,16,0.92)",
  ...
  return (
    <section className="relative" data-testid="systemtest-page">
      ...
      <div className="rounded-2xl border border-white/[0.08] backdrop-blur-xl px-3.5 sm:px-5 py-3 mb-3 flex items-center gap-3 flex-wrap"
           style={{ background: "rgba(5,0,16,0.55)" }}>
        <span
      ...
      <AnimatePresence mode="wait">
        <motion.article
          ...
          style={{
            background:
              "radial-gradient(ellipse at top, rgba(155,92,255,0.10), transparent 60%), rgba(5,0,16,0.58)",
      ...
      {stage === "submitting" && (
        <div className="fixed inset-0 z-[1400] flex items-center justify-center"
          ...
          <div className="rounded-2xl border border-aurora-cyan/40 px-6 py-5 backdrop-blur-xl text-center"
               style={{ background: "rgba(5,0,16,0.85)" }}>

  ...
  return (
    ...
    >
      <div className="flex items-center gap-4">
        {/* Big numeral */}
        <div
          className="relative h-16 w-16 shrink-0 flex items-center justify-center rounded-2xl"
          style={{
            background: `color-mix(in oklab, ${accent} 12%, var(--color-surface-2))`,
          }}
        >
          <span
            className="display tnum text-3xl font-bold leading-none"
            style={{ color: accent }}
